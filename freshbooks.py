...
Updated to be used within ItsRelevant and fixed some major bugs --- AKK
...
def call_api(method, elems=[], call=False, mans=False):
    '''
    ...
    if mans:
        if method.split('.')[0] == 'recurring':
            inv = doc.createElement('recurring')
        else:
            inv = doc.createElement('recurring')
        for key, value in elems.items():
            if isinstance(value, list):
                e = doc.createElement(key)
                ee = doc.createElement('line')
                for val in value:
                    k = val.keys()
                    eee = doc.createElement(k[0])
                    eee.appendChild(doc.createTextNode(str(val[k[0]])))
                    ee.appendChild(eee)
                e.appendChild(ee)
            else:
                e = doc.createElement(key)
        ...
        for key, value in elems.items():
            if isinstance(value, BaseObject):
                ...
                if type(value) is dict:
                    for k in value:
                        ee = doc.createElement(k)
                        ee.appendChild(doc.createTextNode(str(value[k])))
                        e.appendChild(ee)
                else:
                    e.appendChild(doc.createTextNode(str(value)))
...
class Response(object):
    ...
    def client_id(self):
        try:
            return self._doc.getElementsByTagName('client_id')[0].firstChild.nodeValue
        except:
            return None
    ...
    def invoice_id(self):
        try:
            return self._doc.getElementsByTagName('invoice_id')[0].firstChild.nodeValue
        except:
            return None
    ...
    def get_invoice_id(self):
        try:
            return int(self._doc.getElementsByTagName('invoice_id')[0]
    ...
    def get_client_id(self):
        try:
            return int(self._doc.getElementsByTagName('client_id')[0]
                       .firstChild.nodeValue)
        except:
            return None
    ...
    def get_date(self):
        try:
            return str(self._doc.getElementsByTagName('date')[0]
                       .firstChild.nodeValue)
        except:
            return None
    ...
    def get_amount(self):
        try:
            return float(self._doc.getElementsByTagName('amount')[0]
                       .firstChild.nodeValue)
        except Exception, e:
            return None
    ...
    def get_currency_code(self):
        try:
            return str(self._doc.getElementsByTagName('currency_code')[0]
                       .firstChild.nodeValue)
        except:
            return None
    ...
    def get_type(self):
        try:
            return str(self._doc.getElementsByTagName('type')[0]
                       .firstChild.nodeValue)
        except:
            return None
    ...
    def get_reference_id(self):
        try:
            return int(self._doc.getElementsByTagName('reference_id')[0]
                       .firstChild.nodeValue)
        except:
            return None
